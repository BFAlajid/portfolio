...
export const EXPERIENCE: Experience[] = [
  {
    ...
    company: "Accenture",
    description: [
      "Building a secure, large-scale application for a government agency handling case management and workflow automation.",
      "Developing full case lifecycles, flow actions, SLA-driven assignments, and decision rules.",
      "Creating REST integrations with scoped data pages, dynamic tables, and report definitions.",
      "Designing UI/UX with visibility conditions, reusable sections, and validation rules across multiple case types.",
      "Reduced QA cycle time by 40% through Playwright + CRX automated E2E test flows.",
    ],
    skills: [
      SkillNames.REACT,
      SkillNames.JS,
  ...
  },
  {
    ...
    description: [
      "Executed backend testing across APIs, databases, and server-side components for data integrity validation.",
      "Cross-referenced systems against specification memos, flagging inconsistencies as defects.",
      "Evaluated new QA tools and provided functional and usability feedback to engineering team.",
    ],
    skills: [
      SkillNames.REACT,
      SkillNames.NODEJS,
  ...
  },
  {
    ...
    startDate: "May 2019",
    endDate: "Present",
    title: "Freelance Software Developer & IT Consultant",
    company: "Independent",
    description: [
      "Delivered custom software in Java, Python, and C++ for SMEs and individual clients.",
      "Configured Cisco network setups for small businesses.",
      "Built web apps, automation scripts, and workflow tools across diverse industries.",
    ],
    skills: [
      SkillNames.REACT,
      SkillNames.JS,
