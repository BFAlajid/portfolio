    ...
    >
      <div className="w-full max-w-4xl px-4 md:px-8 mx-auto">
        ...
        <div className="flex flex-col gap-8 md:gap-12 relative">
          <div className="absolute left-8 md:left-1/2 top-4 bottom-4 w-px bg-[var(--gold)]/20 hidden md:block -translate-x-1/2" />
      ...
      >
        <CardHeader className="pb-3">
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
            ...
            <Badge variant="secondary" className="w-fit font-mono text-xs font-normal border border-[var(--gold)]/20 text-[var(--gold)]">
